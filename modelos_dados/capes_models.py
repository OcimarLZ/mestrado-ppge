...
class BolsaNacional(db.Model):
    ...
    ies_codigo = db.Column(db.Integer, db.ForeignKey('superior_ies.codigo'), nullable=True)
    ...
    grande_area = db.Column(db.Integer, db.ForeignKey('superior_area.codigo'), nullable=True)
