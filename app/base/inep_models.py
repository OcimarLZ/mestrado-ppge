...
class RegiaoIntermediaria(db.Model):
    ...
    codigo = db.Column(db.Integer, primary_key=True)
    nome = db.Column(db.String(12), nullable=False)
    estado = db.Column(db.String(2), db.ForeignKey('uf.sigla'), nullable=False)
...
class Microrregiao(db.Model):
    ...
    codigo = db.Column(db.Integer, primary_key=True)
    nome = db.Column(db.String(60), nullable=False)
    mesorregiao = db.Column(db.Integer, db.ForeignKey('mesorregiao.codigo'), nullable=False)
...
class Municipio(db.Model):
    ...
    estado = db.Column(db.String(2), db.ForeignKey('uf.sigla'), nullable=False)
    mesorregiao = db.Column(db.Integer, db.ForeignKey('mesorregiao.codigo'), nullable=False)
    microrregiao = db.Column(db.Integer, db.ForeignKey('microrregiao.codigo'), nullable=False)
    natureza = db.Column(db.Text, nullable=True)
    hierarquia = db.Column(db.String(1), nullable=True)
    regiao_intermediaria = db.Column(db.Integer, db.ForeignKey('regiao_intermediaria.codigo'), nullable=True)
    regiao_imediata = db.Column(db.Integer, db.ForeignKey('regiao_imediata.codigo'), nullable=True)


class MunicipioCenso(db.Model):
    __tablename__ = 'municipio_censo'
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    municipio = db.Column(db.String(12), db.ForeignKey('municipio.codigo'), nullable=False)
...
class Area_detalhada(db.Model):
    ...
    codigo = db.Column(db.Integer, primary_key=True)
    nome = db.Column(db.String(50), nullable=False)
    area_especifica = db.Column(db.Integer, db.ForeignKey('area_especifica.codigo'), nullable=False)
...
class Curso(db.Model):
    ...
    codigo = db.Column(db.Integer, primary_key=True)
    nome = db.Column(db.String(100), nullable=False)
    area_detalhada = db.Column(db.Integer, db.ForeignKey('area_detalhada.codigo'), nullable=False)
...
class Ies(db.Model):
    ...
    mesorregiao = db.Column(db.Integer, db.ForeignKey('mesorregiao.codigo'), nullable=False)
    microrregiao = db.Column(db.Integer, db.ForeignKey('microrregiao.codigo'), nullable=False)
    org_academica = db.Column(db.Integer, db.ForeignKey('tp_organizacao_academica.codigo'), nullable=False)
    categoria = db.Column(db.Integer, db.ForeignKey('tp_categoria_administrativa.codigo'), nullable=False)
    mantenedora = db.Column(db.Integer, db.ForeignKey('mantenedora.codigo'), nullable=False)
    tp_rede = db.Column(db.Integer, db.ForeignKey('tp_rede.codigo'), nullable=True)
...
class Unidade(db.Model):
    ...
    ies = db.Column(db.Integer, db.ForeignKey('ies.codigo'), nullable=False)
...
class Curso_censo(db.Model):
    ...
    ano_censo = db.Column(db.Integer, nullable=True)
    regiao = db.Column(db.Integer, db.ForeignKey('regiao.codigo'), nullable=True)
    estado = db.Column(db.String(2), db.ForeignKey('uf.sigla'), nullable=True)
    municipio = db.Column(db.String(12), db.ForeignKey('municipio.codigo'), nullable=True)
    dimensao = db.Column(db.Integer, db.ForeignKey('tp_dimensao.codigo'), nullable=True)
    org_academica = db.Column(db.Integer, db.ForeignKey('tp_organizacao_academica.codigo'), nullable=True)
    categoria = db.Column(db.Integer, db.ForeignKey('tp_categoria_administrativa.codigo'), nullable=True)
    tp_rede = db.Column(db.Integer, db.ForeignKey('tp_rede.codigo'), nullable=True)
    ies = db.Column(db.Integer, db.ForeignKey('ies.codigo'), nullable=True)
    curso = db.Column(db.Integer, db.ForeignKey('curso.codigo'), nullable=True)
    cine_rotulo = db.Column(db.String(10), db.ForeignKey('cine_rotulo.codigo'), nullable=True)
    area_geral = db.Column(db.Integer, db.ForeignKey('area.codigo'), nullable=True)
    area_especifica = db.Column(db.Integer, db.ForeignKey('area_especifica.codigo'), nullable=True)
    area_detalhada = db.Column(db.Integer, db.ForeignKey('area_detalhada.codigo'), nullable=True)
    tp_grau_academico = db.Column(db.Integer, db.ForeignKey('tp_grau_academico.codigo'), nullable=True)
    in_gratuito = db.Column(db.Boolean, nullable=True)
    tp_modalidade_ensino = db.Column(db.Integer, db.ForeignKey('tp_modal_ensino.codigo'), nullable=True)
    tp_nivel_academico = db.Column(db.Integer, db.ForeignKey('tp_nivel_academico.codigo'), nullable=True)
    # Vagas
...
class Uab_censo(db.Model):
    ...
    regiao_polo = db.Column(db.Integer, db.ForeignKey('regiao.codigo'), nullable=True)
    uf_polo = db.Column(db.String(2), db.ForeignKey('uf.sigla'), nullable=True)
    ...
    id_nivel_academico = db.Column(db.Integer, db.ForeignKey('tp_nivel_academico.codigo'), nullable=True)
