...
arq_nome = 'cursos_ano_categoria_administrativa_qtde'
...
<table style="width: 100%; border-collapse: collapse;">
    <tr style="background-color: #2E7D32;">
        <th colspan="{len(df.columns)}" style="font-size: 14px; font-family: Tahoma, sans-serif; color: white; padding: 10px; text-align: center;">
            Ensino Superior - Nível Graduação: Evolução do número de cursos ofertados em Chapecó por Categoria Administrativa
        </th>
    </tr>
</table>
"""
...
plot_line(df, 'ano', 'privada sem fins lucrativos', 'Privada sem fins lucrativos', '#8A2BE2')  # Azul violeta para linha privada sfl
...
plt.title('Ensino Superior - Nível Graduação: Evolução do número de cursos ofertados em Chapecó por categoria administrativa', color='#556B2F')  # Verde oliva forte para o título
