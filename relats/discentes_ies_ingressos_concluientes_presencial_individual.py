...
arq_nome = 'ies_ingressos_concluintes_por_ano_presencial'
...
<table style="width: 100%; border-collapse: collapse;">
    <tr style="background-color: #2E7D32;">
        <th colspan="{len(df_pivot.columns) + 2}" style="font-size: 14px; font-family: Tahoma, sans-serif; color: white; padding: 10px; text-align: center;">
            Ensino Superior - Nível Graduação: Evolução dos Totais de Ingressantes e Concluintes por IES em Chapecó Modalidade Presencial
        </th>
    </tr>
...
for ies in ies_list:
    ...
    plt.title(f'Evolução dos Totais de Ingressantes e Concluintes na IES Modalidade Presencial: {ies_label}',
...
plt.title('Evolução dos Ingressantes por IES em Chapecó Modalidade Presencial', color='#000000')  # Preto para o título
...
plt.title('Evolução dos Concluintes por IES em Chapecó Modalidade Presencial', color='#000000')  # Preto para o título
plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=3, fontsize='small')  # Mover legenda para o rodapé
plt.grid(True)
...
plt.xlabel('Ano')
plt.ylabel('Quantidade de Ingressantes')
plt.title('Evolução dos Ingressantes das 10 Maiores IES e Outras em Chapecó Modalidade Presencial', color='#000000')
...
plt.xlabel('Ano')
plt.ylabel('Quantidade de Concluintes')
plt.title('Evolução dos Concluintes das 10 Maiores IES e Outras em Chapecó Modalidade Presencial', color='#000000')
plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=3, fontsize='small')
plt.grid(True)
