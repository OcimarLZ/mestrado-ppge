...
arq_nome = 'discentes_numeros_globais_licenciaturas'
...
<table style=\"width: 100%; border-collapse: collapse;\">
    <tr style=\"background-color: #2E7D32;\">
        <th colspan=\"{len(colunas_html)}\" style=\"font-size: 14px; font-family: Tahoma, sans-serif; color: white; padding: 10px; text-align: center;\">
            Discentes: Números Globais das Licenciaturas por Ano
        </th>
    </tr>
</table>
"""
...
ax.set_title('Discentes: Números Globais das Licenciaturas por Ano', color='#000000', fontsize=14)
