...
FROM curso_censo c
JOIN tp_rede tp on tp.codigo = c.tp_rede
...
col_widths   = ["70px"] + ["70px"] + ["140px"] * pivot_mat.shape[1]
alinhamentos = ["left"] + ["left"] + ["right"] * pivot_mat.shape[1]
...
fig = px.line(fig_df,
              ...
              title='Licenciaturas – Matrículas por Rede eModalidade (a partir de 2005)')
