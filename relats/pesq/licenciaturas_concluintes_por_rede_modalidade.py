...
pivot_df = df.pivot_table(index='ano', columns=['rede', 'modalidade'], values='QtdeConcluintes', fill_value=0).astype(int)
...
arq_nome = 'licenciaturas_concluintes_por_rede_modalidade'
...
ax.set_title('Concluintes em Licenciaturas por Tipo de Rede e Modalidade', color='#000000', fontsize=14)
