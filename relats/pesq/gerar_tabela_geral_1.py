"""
Script principal para gerar planilha Excel com dados do INEP.
Utiliza módulos modulares para organização e manutenibilidade.
"""
...
# Importa os módulos modulares - usando imports absolutos para compatibilidade
try:
