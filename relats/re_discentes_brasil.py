...
arq_nome = 're_evolucao_discentes_brasil'
...
<table style="width: 100%; border-collapse: collapse;">
    <tr style="background-color: #2E7D32;">
        <th colspan="{len(df.columns)}" style="font-size: 14px; font-family: Tahoma, sans-serif; color: white; padding: 10px; text-align: center;">
            Evolução de Vagas, Inscritos, Ingressantes e Matrículas por Ano
        </th>
    </tr>
</table>
"""
...
plt.title('Evolução de Vagas, Inscritos, Ingressantes e Matrículas por Ano no Brasil - Total',
