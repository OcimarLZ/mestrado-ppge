...
def gerar_mapa_combinado_a4(
    ...
    fig.suptitle(
        f'Comparativo de Municípios (Polos UAB Ativos e IES Específicas): {ano_ini} × {ano_fim}',
        fontsize=13,
        fontweight='bold',
        y=0.97,
    )
...
def main() -> None:
    ...
    output_path = f'docs/graficos/mapa_municipios_polo_uab_2periodos_{anos_str}_ies_a4.png'
