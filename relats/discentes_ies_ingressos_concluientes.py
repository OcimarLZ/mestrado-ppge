...
for ies in ies_list:
    ...
    plt.title(f'Evolução dos Totais de Ingressantes e Concluintes na IES: {ies_label}',
...
plt.title('Evolução dos Ingressantes por IES em Chapecó', color='#000000')  # Preto para o título
...
plt.title('Evolução dos Concluintes por IES em Chapecó', color='#000000')  # Preto para o título
plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=3, fontsize='small')  # Mover legenda para o rodapé
plt.grid(True)
...
plt.xlabel('Ano')
plt.ylabel('Quantidade de Ingressantes')
plt.title('Evolução dos Ingressantes das 10 Maiores IES e Outras em Chapecó', color='#000000')
...
plt.xlabel('Ano')
plt.ylabel('Quantidade de Concluintes')
plt.title('Evolução dos Concluintes das 10 Maiores IES e Outras em Chapecó', color='#000000')
plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=3, fontsize='small')
plt.grid(True)
